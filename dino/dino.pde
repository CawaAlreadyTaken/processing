...
int ndin = 10;  //min: 2, max: what your pc can handle.
int dinoHeight = 30;
int dinoWidth = 10;
//____________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
...
void draw() {
  ...
  textSize(20);
  if (player == 2) {
    text("Best: "+best, width*5/9, height/10);
  }
  text("Score: "+(-int(score/100)), width*7/9, height/10);
  if (player == 1) {
    pY+=speedPY;
...
class Dino {
  ...
  float[][] IL = new float[3][2];
  float[][] L3 = new float[2][1];
...
void randomize()
{
  for (int i = ndin/2; i<ndin; i++)
  {
    ...
    for (int j = 0; j<ndin/3; j++)
    {
      int x = int(random(0, ndin/10));
      for (int z = 0; z<x; z++)
      {
